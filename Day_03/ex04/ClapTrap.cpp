...
ClapTrap::ClapTrap(int hp, int mhp, int ep, int mep, int l, int mad, int rad, int add, std::string name)
{
    this->_Hit_points = hp;
    this->_Max_Hit_points = mhp;
    this->_Energy_points = ep;
    this->_Max_Energy_points = mep;
    this->_Level =  l;
    this->_Melee_attack_damage = mad;
    this->_Ranged_attack_damage = rad;
    this->_Armor_damage_destruction = add;
    this->_Name = name;
    std::cout << "Construction of ClapTrap..." << std::endl;
}
