...
NinjaTrap::NinjaTrap() : ClapTrap(60, 60, 120, 120 , 1, 60, 5, 0, "unnamed")
{
...
int NinjaTrap::getEnergyPoint(void)
{
	return(this->_Energy_points);
}

int NinjaTrap::getMaxEnergyPoint(void)
{
	return(this->_Max_Energy_points);
}

int NinjaTrap::getMeleeAttackDamage(void)
{
