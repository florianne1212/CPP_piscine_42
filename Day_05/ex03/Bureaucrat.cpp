...
/*   Updated: 2020/12/05 14:23:52 by fcoudert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form & form)
{
	if(this->_grade > form.getGradeExecute())
		std::cout << _name << " can't execute " << form.getName() << " because his grade is too low" << std::endl;
	else if(form.getSigned() == false)
		std::cout << _name << " can't execute " << form.getName() << " because the form is not signed" << std::endl;
	else
		form.execute(*this);	
}
